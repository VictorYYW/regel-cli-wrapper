...
public class LexicalEntry {
  ...
  public static class LexicalEntrySerializer {
    ...
    public static LispTree entryToLispTree(LexicalEntry rawEntry) {
      ...
      if (rawEntry instanceof EntityLexicalEntry) {
        EntityLexicalEntry entry = (EntityLexicalEntry) rawEntry;
      ...
      } else if (rawEntry instanceof UnaryLexicalEntry) {
        UnaryLexicalEntry entry = (UnaryLexicalEntry) rawEntry;
        ...
        result.addChild(setToLispTree(entry.types));
      } else if (rawEntry instanceof BinaryLexicalEntry) {
        BinaryLexicalEntry entry = (BinaryLexicalEntry) rawEntry;
